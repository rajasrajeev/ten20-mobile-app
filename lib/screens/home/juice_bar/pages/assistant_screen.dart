...
import 'package:ten20/screens/home/juice_bar/pages/drink_details_screen.dart';
            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  const Text('Select Smoothie', style: contentHeader)
                ],
              ),
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const DrinkDetailsScreen()));
                      },
                      child: ServiceCard(
